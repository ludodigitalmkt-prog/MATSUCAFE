...
// ==========================================
// 3. CONFIGURAÇÕES GERAIS E LOGIN
// ==========================================
...
// ==========================================
// 5. PRODUTOS (COM PROTEÇÃO CONTRA ERROS)
// ==========================================
async function loadProducts() {
    onSnapshot(collection(db, "produtos"), (snapshot) => {
        ...
        snapshot.forEach((docSnap) => {
            ...
            // TRAVA DE SEGURANÇA para produtos antigos
            const p = { 
                id: docSnap.id, 
...
document.getElementById('btn-add-product').addEventListener('click', async () => {
    ...
    if(!nome || isNaN(preco)) return alert("Nome e Preço de venda obrigatórios!");
...
document.getElementById('btn-checkout').addEventListener('click', async () => {
    ...
    } catch(e) { return alert("Erro no banco de dados."); }
    
    // Geração do Recibo Térmico Inteligente
    let itemsHtml = '';
