...
// Futuramente, você importará o Firestore e Auth aqui:
...
// ---------------------------------------------------
// LÓGICA DO PDV (FRENTE DE CAIXA)
// ---------------------------------------------------

// Banco de Dados Simulado (Futuramente os produtos virão do Firestore)
const products = [
...
function checkout() {
    ...
    alert("Venda Registrada! (Futuramente isso salvará no Firebase e Imprimirá o Recibo)");
    clearCart();
    toggleCartMobile();
}
...
// Como estamos usando type="module", precisamos expor as funções para o HTML (window)
